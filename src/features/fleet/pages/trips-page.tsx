...
import { useTripsPageModel } from "@/features/fleet/page-models/use-trips-page-model";

export function TripsPage() {
  const model = useTripsPageModel();
  ...
  return (
    <div className="space-y-6">
      ...
      <ChartCard
        ...
        action={
          <ChartLimitControl value={model.tripChartLimit} onChange={model.setTripChartLimit} />
        }
      >
        {model.isChartLoading ? (
          <Skeleton className="h-[340px] w-full" />
        ) : (
          <ResponsiveContainer width="100%" height={340}>
            <BarChart
              data={model.chartEfficiency}
